Linkedin = {
    config: {
      ...
      actionDelay: 5000,
      nextPageDelay: 5000,
      // change this to the number of requests you want to send, change it to -1 for unlimited requests
      maxRequests: 3,
      totalRequestsSent: 0,
      // set to false to skip adding note in invites
      addNote: true,
      note: "Hey {{name}}, I am currently working in Amazon and interested in joining Salesforce. Let me know if there are any opportunities!",
    },
